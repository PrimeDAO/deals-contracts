...
contract("Whole rundown", async (accounts) => {
    ...
    it("deposit check", async () => {
        ...
        let depositAddrDao1 = await baseContractInstance.depositContract(
            daos[0]
        );
        ...
        let depositAddrDao2 = await baseContractInstance.depositContract(
            daos[1]
        );
        ...
        let depositAddrDao3 = await baseContractInstance.depositContract(
            daos[2]
        );
